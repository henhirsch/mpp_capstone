...
colnames(contracts3_small) <- c("fips", "total_obligated_amount_sum")
```
...
```{r map all installations color coded by contract funding}
# set caption text
...
all_installations_contracts_map <- plot_usmap() +
  ...
  labs(title = "Total DOD Financial Readiness Contract Funding per U.S. Military Installation",
       subtitle = "Installation headcount data is from 2019. County-level contract funding data is aggregated from 2006 - 2023.",
