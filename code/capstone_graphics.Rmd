...
# set caption text
installations_caption_text <- paste("Source: 2019 Department of Defense Demographics Report. No newer data on military installation headcounts is available. The Department of Defense stopped publishing disaggregated headcount data after 2019.")
