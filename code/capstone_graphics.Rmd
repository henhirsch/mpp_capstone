...
# set caption text
installations_rent_caption_text <- paste("Sources: The Department of Defense's 2019 Demographics Report and the the U.S. Census Bureau's American Community Survey, 5-Year Data (2009-2022)")
...
all_installations_rent_map <- plot_usmap() +
  ...
  labs(title = "Median Contract Rent for Counties Containing U.S. Military Installations (2022)",
       subtitle = "Headcount data is from 2019. Rent data is from 2022.",
       caption = installations_rent_wrapped_caption) + 
  scale_color_continuous(name = "Median Rent",
                         low = "yellow", high = "red") +
  scale_size_continuous(labels = comma, 
                        name = "Installation Headcount") +
  theme(plot.title = element_text(hjust = 0, size = 25),
