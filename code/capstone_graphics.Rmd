...
```{r map military installation headcounts}
...
test_data1 <- test_data1[, c("state", "base", "service_branch", "zip_code", "coordinates", "longitude", "latitude", "nmc", "miles_to_nmc", "total_sponsors", "total_spouses", "children0-5", "children6-11", "children12-18", "children19andup", "other_dependents", "total_personnel")]
...
dot_map <- plot_usmap() +
  geom_sf(
    ...
    aes(size = total_sponsors, fill = service_branch)
  )
